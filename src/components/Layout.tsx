    ...
    <div className="site-frame">
      ...
      <footer className="site-footer">
        ...
        <div className="page-shell site-footer__badges" aria-label="Radiogram directory listings">
          ...
          <a href="https://www.foundrlist.com/product/radiogram?utm_source=badge&amp;utm_medium=embed" target="_blank" rel="noopener"><img src="https://www.foundrlist.com/api/badge/radiogram" alt="Featured on FoundrList" width="150" height="48" loading="lazy" /></a>
