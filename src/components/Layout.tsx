    ...
    <div className="site-frame">
      ...
      <footer className="site-footer">
        ...
        <div className="page-shell site-footer__badges" aria-label="Radiogram directory listings">
          ...
          <a href="https://launchpanda.dev/launches" target="_blank" rel="noopener"><img src="https://launchpanda.dev/images/badges/launchpanda-badge.svg" alt="Launched on LaunchPanda" width="260" height="64" loading="lazy" /></a>
