    ...
    <div className="site-frame">
      ...
      <footer className="site-footer">
        ...
        <div className="page-shell site-footer__badges" aria-label="Radiogram directory listings">
          ...
          <a href="https://toolfio.com" target="_blank" rel="noopener"><img src="https://toolfio.com/toolfio-light-badge.png" alt="Featured on Toolfio" width="200" height="54" /></a>
          <a href="https://findly.tools/radiogram?utm_source=radiogram" target="_blank" rel="noopener noreferrer"><img src="https://findly.tools/badges/findly-tools-badge-light.svg" alt="Featured on Findly.tools" width="175" height="55" loading="lazy" /></a>
          <a href="https://saasbison.com" target="_blank" rel="dofollow"><img src="https://saasbison.com/badge.png" alt="Featured on SaaSBison" width="200" height="54" loading="lazy" style={{ filter: "invert(1)" }} /></a>
          ...
          <a href="https://startupog.com" target="_blank" rel="noopener"><img src="https://startupog.com/startupog-badge.webp" alt="Featured on StartupOG" width="150" height="75" loading="lazy" style={{ filter: "invert(1)" }} /></a>
          <a href="https://www.scrolllaunch.com/products/radiogram-radio-podcasts?ref=badge" target="_blank" rel="noopener"><img src="https://www.scrolllaunch.com/api/badge/radiogram-radio-podcasts" alt="Featured on ScrollLaunch" width="220" height="48" loading="lazy" /></a>
          <a href="https://noonlaunch.com/product/radiogram" target="_blank" rel="dofollow noopener"><img src="https://noonlaunch.com/badges/radiogram.svg?theme=dark" alt="Featured on Noonlaunch" width="220" height="60" loading="lazy" /></a>
          <a href="https://indieshowcase.io"><img src="https://indieshowcase.io/badge/featured-light.svg" alt="Featured" /></a>
