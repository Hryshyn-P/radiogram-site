    ...
    <div className="site-frame">
      ...
      <footer className="site-footer">
        ...
        <div className="page-shell site-footer__badges" aria-label="Radiogram directory listings">
          ...
          <a href="https://saasbison.com" target="_blank" rel="dofollow"><img src="https://saasbison.com/badge.png" alt="Featured on SaaSBison" width="200" height="54" loading="lazy" /></a>
